        ...
        <tr style="    height: 100px; ">
            <td style="border: 6px solid #017272; background-color: #017272;">
                <div style="background-color: white; float: left; padding: 0px 12px 0px; height: 100%; border-radius: 5px; border: 2px ridge #017272; color: #017272; font-family: 'Century Gothic',Arial; align-content: center; text-align: center;">
                    ...
                    <div>
                        <H5 style=" margin-bottom: 0px; margin-top: 0px;">Personal</H5>
                    </div>
                </div>
                ...
                <div onclick="location.href='/Administrar/Clientes'" style="float: left; padding: 0px 12px 0px; height: 100%; border-radius: 5px; border: 2px ridge gold; color: gold; font-family: 'Century Gothic',Arial; align-content: center; text-align: center;">
                    ...
                    <div>
                        ...
                        <table style="float: left; ">
                            <tr style="height:20px;">
                                ...
                                <td>
                                    <input type="text" onKeyUp="PaginaLista.location.href='/Personal/Lista?Filtro='+this.value+''">
                                </td>
                                <td>
                                    <div onclick="PaginaLista.location.href='/Personal/Lista" style="float: right; padding: 0px 12px 0px; height: 100%; border-radius: 5px; border: 2px ridge gold; color: gold; font-family: 'Century Gothic',Arial; align-content: center; text-align: center;">
                                        <table>
                                            <tr>
                                                <td>
                                                    Actualizar
                        ...
                        <table style="margin:0px;width:100%;height:100%;">
                            <tr>
                                <td>
                                    <iframe name="PaginaLista" src="/Personal/Lista" style="margin:0px;width: 100%; height:100%;border:0px solid blue;overflow:hidden;"></iframe>
                                </td>
                            </tr>
                        </table>
                    </div>
