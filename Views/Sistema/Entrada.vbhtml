        ...
        <tr style="height:30px;">
            ...
            <td style="width:300px;">
                <div style="padding:0px 12px 0px;width:auto;height:20px; border-radius:13px; color:gold;font-family:'Century Gothic',Arial; align-content:center;text-align:center ;">
                    ...
                    @Html.ActionLink("Sistema", "Index", "Manage", routeValues:=Nothing, htmlAttributes:=New With {.Style = "Color:gold; text-decoration:none;"})
                    <div style="width:5px;">
        ...
        <tr>
            <td colspan="3">
                <div style="height:100%;width:100%;">
                    <iframe name="Paginas" src="/Sistema/PermisoUsoDeAplicacion" style="margin:0px;width: 100%; height:100%;border:0px solid blue;overflow:hidden;"></iframe>
                </div>
            </td>
        </tr>
        <tr>
